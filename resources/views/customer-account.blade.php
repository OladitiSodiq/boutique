...
<!-- Mirrored from demo.bootstrapious.com/hub/1-4-2/customer-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Sep 2019 12:27:27 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="right-col d-flex align-items-lg-center flex-column flex-lg-row">
              ...
              <div class="user dropdown show"><a id="userdetails" href="https://example.com/" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="icon-profile"></i></a>
                <ul aria-labelledby="userdetails" class="dropdown-menu"> 
                  <li class="dropdown-item"><a href="customer-orders.html">Orders</a></li>
                  <li class="dropdown-item"><a href="customer-addresses.html">Addresses</a></li>
                  <li class="dropdown-item"><a href="customer-account.html">Profile     </a></li>
