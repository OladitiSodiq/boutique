  ...
  <!-- Custom scripts for all pages-->
    ...
    <!-- Page level plugins -->
  <script src="/dashhboard/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="/dashhboard/vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="/dashhboard/js/demo/datatables-demo.js"></script>
